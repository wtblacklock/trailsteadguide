...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE_URL}/compare`, lastModified: FRESH, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/compare/best-beginner-tent`, lastModified: FRESH, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE_URL}/compare/best-beginner-cooler`, lastModified: FRESH, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/compare/lantern-vs-headlamp-vs-flashlight`, lastModified: FRESH, changeFrequency: 'monthly', priority: 0.7 },
