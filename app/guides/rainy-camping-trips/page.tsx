  ...
  return (
    <>
      ...
      >
        ...
        <p>
          See also: <Link href="/guides/spring-camping-for-beginners">Spring Camping for Beginners</Link> for the season this guide overlaps with most, and <Link href="/guides/camping-when-the-weather-turns">Camping When the Weather Turns</Link> for what to do when a clear forecast shifts on you mid-trip. If you&apos;re still picking dates, <Link href="/quiz">take the 5-second quiz</Link> and we&apos;ll match a starter plan to a drier window.
        </p>
      ...
      <GuidePrintablesBlock guideSlug="rainy-camping-trips" />
