  ...
  return (
    <>
      ...
      >
        ...
        <p>
          See also: <Link href="/guides/summer-camping-for-beginners">Summer Camping for Beginners</Link> for the broader summer playbook, <Link href="/guides/summer-camping-with-kids">summer camping with kids</Link> for the kid-specific heat layer, and <Link href="/guides/camping-in-texas-for-beginners">Camping in Texas</Link> or{' '}
          <Link href="/guides/camping-in-the-desert-southwest-for-beginners">Desert Southwest</Link> if you camp in regions where heat is the default summer condition. If you&apos;re weighing whether to reschedule, <Link href="/quiz">take the 5-second quiz</Link> and we&apos;ll match a cooler-weather plan to your dates.
        </p>
      ...
      <GuidePrintablesBlock guideSlug="camping-in-a-heatwave" />
