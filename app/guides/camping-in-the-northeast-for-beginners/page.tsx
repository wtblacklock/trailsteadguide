...
export default function Page() {
  return (
    ...
    >
      ...
      <p>
        These are the three beginner trip types that work in the Northeast, mapped to plans on this site. <Link href="/quiz">Take the 5-second quiz</Link> if you want one matched to your dates and the foliage window. If a wet shoulder weekend rolls in, see <Link href="/guides/rainy-camping-trips">camping in the rain</Link>.
      </p>
      <ul>
        <li>
    ...
    <GuidePrintablesBlock guideSlug="camping-in-the-northeast-for-beginners" />
    <GuideGearShelf guideSlug="camping-in-the-northeast-for-beginners" />
    <GuideArticleCTA />
