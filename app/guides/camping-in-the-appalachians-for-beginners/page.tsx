    ...
    >
      ...
      <div className="not-prose my-12 rounded-2xl bg-stone-900 text-white p-8 md:p-10">
        ...
        <p className="text-stone-300 leading-relaxed mb-6 max-w-xl">
          Answer 5 questions and we&apos;ll match the timeline, gear, and meals to your dates, your party, and where in the Appalachians you&apos;re going.
        </p>
        <div className="flex flex-wrap gap-3">
          ...
          >
            Get your exact plan for the Appalachians
          </Link>
        </div>
      </div>
