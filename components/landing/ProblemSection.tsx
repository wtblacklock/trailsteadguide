    ...
    <section className="py-16 md:py-36 max-w-page mx-auto px-8">
      ...
      <div>
        {problems.map((problem) => (
          <div key={problem.number} className="grid grid-cols-12 gap-x-6 gap-y-3 py-6 md:py-8 border-t border-stone-200">
            ...
            <div className="col-span-11 col-start-2 md:col-span-6 md:col-start-6">
