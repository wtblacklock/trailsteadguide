      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="col-span-1 md:col-span-5 md:col-start-8">
          <div className="relative h-full min-h-[600px] rounded-2xl overflow-hidden">
            <Image
              src="https://images.unsplash.com/photo-1551632811-561732d1e306?w=900&auto=format&fit=crop&q=80"
              alt="Group of family and friends hiking together on a forest trail"
              fill
