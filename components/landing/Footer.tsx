      ...
      <div className="max-w-page mx-auto px-8 pt-16 pb-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-6">
          ...
          <div className="col-span-1 md:col-span-2 space-y-8">
            ...
            <FooterCol title="Site" items={[{ label: 'Skills', href: '/skills' }, { label: 'Activities', href: '/activities' }, { label: 'Gear', href: '/gear' }, { label: 'Printables', href: '/printables' }, { label: 'Glossary', href: '/glossary' }, { label: 'About', href: '/about' }, ...FOOTER_SECONDARY]} bare />
          </div>
